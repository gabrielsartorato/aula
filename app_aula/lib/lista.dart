      ...
      home: Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            leading: Builder(
              // ADICIONANDO O LOGO IMG INSTACARES
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Container(
                        ...
                        child:
                            crialogohospital('hospital 1', 'imagens/001.png')),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(10),
                    child: Container(
...
Widget crialogohospital(String texto, imagem) {
  return Padding(
    //alinhamento da linha toda
    padding: const EdgeInsets.all(5),
    //  padding: const EdgeInsets.fromLTRB(5, 14, 0, 0),
    child: Row(
      //linha principal onde esta o texto e o coraçao <3
      ...
      children: <Widget>[
        Column(
          //colunha do coraçao <3
          children: <Widget>[
            Row(
              children: <Widget>[
                Padding(
                  //alinhamento do coraçao >3
                  // padding: const EdgeInsets.fromLTRB(15, 3, 5, 1),
                  padding: const EdgeInsets.all(1),
                  child: SizedBox(
                    //caixinha onde esta o coraçao para ajustar o tamanho
                    height: 50,
                    width: 50,
                    child: Container(
                        alignment: Alignment(0.0, 0.0),
                        // margin: new EdgeInsets.symmetric(vertical: 20.0),
                        child: Image.asset(imagem)), //imagem propriamente dita
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.only(left: 10),
                  child: Text(
                    texto, //texto proprimente dito
